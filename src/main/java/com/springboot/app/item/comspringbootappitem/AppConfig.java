package com.springboot.app.item.comspringbootappitem;
...
public class AppConfig {
    ...
    @Bean("clientRest")
    @LoadBalanced
    public RestTemplate singUpRestTemplate() {
    ...
    public Customizer<Resilience4JCircuitBreakerFactory> defaultCustomizer() {
        return factory -> factory.configureDefault(id -> new Resilience4JConfigBuilder(id).circuitBreakerConfig(CircuitBreakerConfig.custom().
                ...
                .build()).timeLimiterConfig(TimeLimiterConfig.custom().timeoutDuration(Duration.ofSeconds(5L))
                .build()).build());
    }
}
